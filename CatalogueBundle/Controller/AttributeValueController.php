...
use CatalogueBundle\Form\AttributeValueType;
...
class AttributeValueController extends Controller
{
     ...
     * @Route("/")
     * @Method("GET")
     * @Template("CatalogueBundle:AttributeValue:index.html.twig")
     */
    public function indexAction($attributeId)
    {
        ...
        $attribute = $em->getRepository('CatalogueBundle:Attribute')->find($attributeId);
    ...
    public function listJsonAction($attributeId)
    {
        ...
        $jsonList->setRepository($em->getRepository('CatalogueBundle:AttributeValue'));
     ...
     * @Route("/")
     * @Method("POST")
     * @Template("CatalogueBundle:AttributeValue:new.html.twig")
     */
    public function createAction(Request $request, $attributeId)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('catalogue_attributevalue_show', array('attributeId' => $attributeId, 'id' => $entity->getId())));
        }
    ...
    public function showAction($attributeId, $id)
    {
        ...
        $entity = $em->getRepository('CatalogueBundle:AttributeValue')->find($id);
    ...
    public function updateAction(Request $request, $attributeId, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('catalogue_attributevalue_show', array('attributeId' => $attributeId, 'id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $attributeId, $id)
    {
        ...
        return $this->redirect($this->generateUrl('catalogue_attributevalue_index', array('attributeId' => $attributeId)));
    }
