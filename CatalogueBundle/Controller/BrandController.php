...
class BrandController extends Controller
{
     ...
     * @Route("/")
     * @Method("GET")
     * @Template("CatalogueBundle:Brand:index.html.twig")
     */
    ...
    public function listJsonAction()
    {
        ...
        $jsonList->setRepository($em->getRepository('CatalogueBundle:Brand'));
    ...
    {
        $entity = new Brand();
        $form = $this->createForm('CatalogueBundle\Form\BrandType', $entity);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('catalogue_brand_show', array('id' => $entity->getId()));
        }
    ...
    public function editAction(Request $request, Brand $brand)
    {
        ...
        $deleteForm = $this->createDeleteForm($brand);
        $editForm = $this->createForm('CatalogueBundle\Form\BrandType', $brand);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('catalogue_brand_show', array('id' => $brand->getId()));
        }
    ...
    public function deleteAction(Request $request, Brand $brand)
    {
        ...
        return $this->redirectToRoute('catalogue_brand_index');
    }
   ...
   /**
    ...
    private function createDeleteForm(Brand $brand)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('catalogue_brand_delete', array('id' => $brand->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
