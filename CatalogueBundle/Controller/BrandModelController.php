...
class BrandModelController extends Controller
{
     ...
     * @Route("/")
     * @Method("GET")
     * @Template("CatalogueBundle:BrandModel:index.html.twig")
     */
    ...
    public function listJsonAction()
    {
        ...
        $jsonList->setRepository($em->getRepository('CatalogueBundle:BrandModel'));
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CatalogueBundle\Form\BrandModelType', $entity);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('catalogue_brandmodel_show', array('id' => $entity->getId()));
        }
    ...
    public function editAction(Request $request, BrandModel $brandModel)
    {
        ...
        $deleteForm = $this->createDeleteForm($brandModel);
        $editForm = $this->createForm('CatalogueBundle\Form\BrandModelType', $brandModel);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('catalogue_brandmodel_show', array('id' => $brandModel->getId()));
        }
    ...
    public function deleteAction(Request $request, BrandModel $brandModel)
    {
        ...
        return $this->redirectToRoute('catalogue_brandmodel_index');
    }
   ...
   /**
    ...
    private function createDeleteForm(BrandModel $brandModel)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('catalogue_brandmodel_delete', array('id' => $brandModel->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
