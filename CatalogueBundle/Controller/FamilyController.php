...
use CatalogueBundle\Form\FamilyType;
...
class FamilyController extends Controller
{
    ...
    public function listJsonAction()
    {
        ...
        $jsonList->setRepository($em->getRepository('CatalogueBundle:Family'));
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('catalogue_family_show', array('id' => $entity->getId())));
        }
    ...
    public function showAction($id)
    {
        ...
        /** @var Family $entity */
        $entity = $em->getRepository('CatalogueBundle:Family')->find($id);
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('catalogue_family_show', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('catalogue_family_index'));
    }
    ...
    public function sortAction(Request $request)
    {
        if ($request->isXmlHttpRequest()) {
            $this->get('admin_manager')->sort('CatalogueBundle:Family', $request->get('values'));
        ...
        $families = $em->getRepository('CatalogueBundle:Family')->findBy(array(), array('order' => 'asc'));
