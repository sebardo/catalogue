...
use CatalogueBundle\Form\FeatureValueType;
...
class FeatureValueController extends Controller
{
     ...
     * @Route("/")
     * @Method("GET")
     * @Template("CatalogueBundle:FeatureValue:index.html.twig")
     */
    public function indexAction($featureId)
    {
        ...
        /** @var Feature $feature */
        $feature = $em->getRepository('CatalogueBundle:Feature')->find($featureId);
    ...
    public function listJsonAction($featureId)
    {
        ...
        $jsonList->setRepository($em->getRepository('CatalogueBundle:FeatureValue'));
     ...
     * @Route("/")
     * @Method("POST")
     * @Template("CatalogueBundle:FeatureValue:new.html.twig")
     */
    public function createAction(Request $request, $featureId)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('catalogue_featurevalue_show', array('featureId' => $featureId, 'id' => $entity->getId())));
        }
    ...
    public function showAction($featureId, $id)
    {
        ...
        $entity = $em->getRepository('CatalogueBundle:FeatureValue')->find($id);
    ...
    public function editAction($featureId, $id)
    {
        ...
        $editForm = $this->createForm('CatalogueBundle\Form\FeatureValueType', $entity);
        $deleteForm = $this->createDeleteForm($featureId, $id);
     ...
     * @Route("/{id}")
     * @Method("PUT")
     * @Template("CatalogueBundle:Feature:edit.html.twig")
     */
    public function updateAction(Request $request, $featureId, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('catalogue_featurevalue_show', array('featureId' => $featureId, 'id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $featureId, $id)
    {
        ...
        return $this->redirect($this->generateUrl('catalogue_featurevalue_index', array('featureId' => $featureId)));
    }
    ...
    private function createDeleteForm($featureId, $id)
    {
        return $this->createFormBuilder(array('featureId' => $featureId, 'id' => $id))
            ->add('featureId', HiddenType::class)
