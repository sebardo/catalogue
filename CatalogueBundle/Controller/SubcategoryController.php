...
use CatalogueBundle\Form\SubcategoryType;
...
class SubcategoryController extends Controller
{
     ...
     * @Route("/")
     * @Method("GET")
     * @Template("CatalogueBundle:Subcategory:index.html.twig")
     */
    public function indexAction($categoryId)
    {
        ...
        /** @var Category $entity */
        $entity = $em->getRepository('CatalogueBundle:Category')->find($categoryId);
     ...
     * @Route("/")
     * @Method("POST")
     * @Template("CatalogueBundle:Category:new.html.twig")
     */
    public function createAction(Request $request, $categoryId)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('catalogue_category_show', array('id' => $entity->getId())));
        }
     ...
     * @Route("/new")
     * @Method("GET")
     * @Template("CatalogueBundle:Subcategory:new.html.twig")
     */
