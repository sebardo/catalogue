 ...
 */
class BrandModelRepository extends EntityRepository
{
    /**
    ...
    public function findAllForDataTables($search, $sortColumn, $sortDirection)
    {
        // select
        $qb = $this->getQueryBuilder()
            ->select('b.id, b.name, b.available, brand.name brandName');

        $qb->join('b.brand', 'brand');
        ...
        switch($sortColumn) {
            ...
            case 1:
                ...
                break;
            case 2:
                $qb->orderBy('brandName', $sortDirection);
                break;
            case 3:
    ...
    private function getQueryBuilder()
    {
        ...
        $qb = $em->getRepository('CatalogueBundle:BrandModel')
