...
namespace CatalogueBundle\Entity\Repository;

use Doctrine\ORM\EntityRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\ORM\Query;
use CatalogueBundle\Entity\Family;
...
class ProductRepository extends EntityRepository
{
    ...
    public function getProductStats(Product $product, $start, $end)
    {
        ...
        $repository = $em->getRepository('CatalogueBundle:ProductStats');
    ...
    public function countTotalStatsVisits()
    {
        ...
        $query = $em->createQuery(
            'SELECT SUM( s.visits ) FROM  CatalogueBundle:ProductStats AS s'
        );
    ...
    public function countVisitsByProduct()
    {
        ...
        $query = $em->createQuery(
            'SELECT SUM(s.visits) as visit,  '
                ...
                . ' FROM CatalogueBundle:ProductStats as s '
    ...
    public function countProductVisited()
    {
        $em = $this->getEntityManager();
        $query = $em->createQuery(
            'SELECT COUNT( DISTINCT s.product ) FROM  CatalogueBundle:ProductStats AS s'
        );
    ...
    public function countProductStatsLine()
    {
        $em = $this->getEntityManager();
        $query = $em->createQuery(
            'SELECT count(s.visits) as visit, s.day as day FROM CatalogueBundle:ProductStats as s GROUP BY s.day ORDER BY s.day ASC '
        );
    ...
    public function bounceRate()
    {
        $em = $this->getEntityManager();
        $query = $em->createQuery(
            'SELECT COUNT( DISTINCT s.product ) FROM  CatalogueBundle:ProductStats AS s WHERE s.visits = :visits'
...
/*        if (array_key_exists('feature-min', $options) && array_key_exists('feature-max', $options)) {
    ...
    private function getQueryBuilder($onlyActive = true)
    {
        ...
        $qb = $em->getRepository('CatalogueBundle:Product')
    ...
    {
        $category_id = $this->getEntityManager()->getRepository('CatalogueBundle:Category')->AssemblyCategory();
