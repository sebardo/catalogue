 ...
 * To run the testcase:
 * @code
 * vendor/bin/phpunit -v src/CatalogueBundle/Tests/Controller/ProductControllerTest.php
 * @endcode
 */
class ProductControllerTest extends CoreTest
{
    ...
    /**
     * @code
     * vendor/bin/phpunit -v --filter testProductAdmin src/CatalogueBundle/Tests/Controller/ProductControllerTest.php
     * @endcode
     * 
     */
    ...
    /**
     * @code
     * phpunit -v --filter testProductActor -c app vendor/sebardo/ecommerce/CatalogueBundle/Tests/Controller/ProductControllerTest.php
     * @endcode
     * 
     */
    ...
    {        
        ...
        //Asserts
        $this->assertTrue($this->client->getResponse()->isSuccessful());
        $this->assertGreaterThan(0, $crawler->filter('html:contains("Edit product '.$uid.'")')->count());
        ...
        $this->assertTrue($this->client->getResponse()->isSuccessful());
        $this->assertGreaterThan(0, $crawler->filter('html:contains("product '.$uid.'")')->count());
        $this->assertGreaterThan(0, $crawler->filter('html:contains("Product has been successfully edited")')->count());
        ...
        //Asserts
        $this->assertTrue($this->client->getResponse()->isSuccessful());
        $this->assertGreaterThan(0, $crawler->filter('html:contains("Product has been successfully deleted")')->count());
